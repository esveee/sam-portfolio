$(function() {
  ...
  $(".typed").typed({
    strings: [
      "stat Sam.human<br/>" +
      "><span class='caret'>$</span> skills: Machine Learning, Computer vision, iOS, Backend Development<br/> ^100" +
      "><span class='caret'>$</span> job: 3D Software Development Intern at <a href='http://www.rocscience.com/'>Rocscience</a><br/> ^100" +
      "><span class='caret'>$</span> hobbies: Weightlifting, Anime, Reading, Theatre <br/> ^300" +
